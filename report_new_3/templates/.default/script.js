...
jQuery.moveColumn(tbl, 11, 1);
jQuery.moveColumn(tbl, 12, 2);
jQuery.moveColumn(tbl, 11, 3);
jQuery.moveColumn(tbl, 12, 4);
jQuery.moveColumn(tbl, 16, 5);
jQuery.moveColumn(tbl, 14, 6);
jQuery.moveColumn(tbl, 16, 7);
