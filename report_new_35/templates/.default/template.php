    ...
    background: url(images/interface/buttons-sprite.png) repeat-x left -217px;
        ...
        background-position-y: -217px;" id="55">Показывать все</span>
                            ...
                            <div class="fakeSelect_item">
                                <input type="checkbox" name="param_filter_forTable[]" value="a_orders_shipped" id="1"<? if (in_array('Отгружено Заказов', $arResult['DATA_TITLES'])) {
                                        echo "checked='true'";
                                    } ?>>
                                <label for="1" style="cursor: pointer;">Отгружено Заказов</label>
                            </div>
  							<div class="fakeSelect_item">
                                <input type="checkbox" name="param_filter_forTable[]" value="a_orders_shipped_summ" id="21"<? if (in_array('Сумма отгруженных заказов (руб без НДС)', $arResult['DATA_TITLES'])) {
                                        echo "checked='true'";
                                    } ?>>
                                <label for="21" style="cursor: pointer;">Сумма отгруженных заказов (руб без НДС)</label>
                            </div>
                            <div class="fakeSelect_item">
                                <input type="checkbox" name="param_filter_forTable[]" value="c_production" id="2"<? if (in_array('Запущен БП Производства Заказа', $arResult['DATA_TITLES'])) {
                                        echo "checked='true'";
                                    } ?>>
                            ...
                            <div class="fakeSelect_item">
                                <input type="checkbox" name="param_filter_forTable[]" value="c_production_summ" id="31"<? if (in_array('Cумма запущенных в пр-во заказов (руб без НДС)', $arResult['DATA_TITLES'])) {
                                        echo "checked='true'";
                                    } ?>>
                                <label for="31" style="cursor: pointer;">Cумма запущенных в пр-во заказов (руб без НДС)</label>
                            </div>
                            <div class="fakeSelect_item">
                                <input type="checkbox" name="param_filter_forTable[]" value="e_planned_shipments" id="3"<? if (in_array('Планируемые отгрузки', $arResult['DATA_TITLES'])) {
                                        echo "checked='true'";
                                    } ?>>
                            ...
                            <div class="fakeSelect_item">
                                <input type="checkbox" name="param_filter_forTable[]" value="f_prihod_ds" id="4"<? if (in_array('Приход ДС (руб без НДС)', $arResult['DATA_TITLES'])) {
                                        echo "checked='true'";
                                    } ?>>
                                <label for="4" style="cursor: pointer;">Приход ДС (руб без НДС)</label>
                            </div>
                            <div class="fakeSelect_item">
                                <input type="checkbox" name="param_filter_forTable[]" value="g_summ_for_deal" id="5"<? if (in_array('Ожидаемые поступления без НДС', $arResult['DATA_TITLES'])) {
                                        echo "checked='true'";
                                    } ?>>
                                <label for="5" style="cursor: pointer;">Ожидаемые поступления без НДС</label>
                            </div>
                            <div class="fakeSelect_item">
                                <input type="checkbox" name="param_filter_forTable[]" value="h_call_outgoing" id="6"
                            ...
                            <div class="fakeSelect_item">
                                <input type="checkbox" name="param_filter_forTable[]" value="i_call_outgoing_2min" id="7" <? if (in_array('Звонки исходящие (Более 2х мин)', $arResult['DATA_TITLES'])) {
                                        echo "checked='true'";
                                    } ?>>
                                <label for="7" style="cursor: pointer;">Звонки исходящие (Более 2х мин)</label>
                            </div>
                            <div class="fakeSelect_item">
                                <input type="checkbox" name="param_filter_forTable[]" value="j_email_sent" id="8"<? if (in_array('E-mail отправленные', $arResult['DATA_TITLES'])) {
                                        echo "checked='true'";
                                    } ?>>
                                <label for="8" style="cursor: pointer;">E-mail отправленные</label>
                            </div>
                            <div class="fakeSelect_item">
                                <input type="checkbox" name="param_filter_forTable[]" value="k_conversion_company" id="9"<? if (in_array('Конверсия Компаний из ПКБ в АКБ', $arResult['DATA_TITLES'])) {
                                        echo "checked='true'";
                                    } ?>>
                                <label for="9" style="cursor: pointer;">Конверсия Компаний из ПКБ в АКБ</label>
                            </div>
                            <div class="fakeSelect_item">
                                <input type="checkbox" name="param_filter_forTable[]" value="l_calc_deal" id="10"<? if (in_array('Открыто Сделок в расчет ПТО', $arResult['DATA_TITLES'])) {
                                        echo "checked='true'";
                                    } ?>>
                                <label for="10" style="cursor: pointer;">Открыто Сделок в расчет ПТО</label>
                            </div>
                            <div class="fakeSelect_item">
                                <input type="checkbox" name="param_filter_forTable[]" value="m_deal_failed" id="11"<? if (in_array('Забраковано Сделок', $arResult['DATA_TITLES'])) {
                                        echo "checked='true'";
                                    } ?>>
                                <label for="11" style="cursor: pointer;">Забраковано Сделок</label>
                            </div>
                            <div class="fakeSelect_item">
                                <input type="checkbox" name="param_filter_forTable[]" value="o_product_testing" id="12"<? if (in_array('Открыто Испытаний', $arResult['DATA_TITLES'])) {
                                        echo "checked='true'";
                                    } ?>>
                                <label for="12" style="cursor: pointer;">Открыто Испытаний</label>
                            </div>
                            <div class="fakeSelect_item">
                                <input type="checkbox" name="param_filter_forTable[]" value="p_product_testing_complete" id="13"<? if (in_array('Завершено Испытаний', $arResult['DATA_TITLES'])) {
                                        echo "checked='true'";
                                    } ?>>
                            ...
                            <div class="fakeSelect_item">
                                <input type="checkbox" name="param_filter_forTable[]" value="q_prihod_ds_whithNDS" id="14"<? if (in_array('Приход ДС (руб с НДС)', $arResult['DATA_TITLES'])) {
                                        echo "checked='true'";
                                    } ?>>
